...
<div class="wp-block-group alignfull"><!-- wp:group {"align":"wide","className":"is-style-default","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide is-style-default"><!-- wp:group {"layout":{"type":"constrained","contentSize":"560px"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center">Features and benefits</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|md","left":"var:preset|spacing|md"},"padding":{"top":"var:preset|spacing|md","bottom":"var:preset|spacing|md"},"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-columns alignwide" id="features" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--md)"><!-- wp:column {"style":{"boxShadow":""},"className":"is-style-surface","shadowPreset":"","shadowPresetHover":""} -->
...
<h6 class="wp-block-heading has-text-align-center">No Code</h6>
<!-- /wp:heading -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":6} -->
<h6 class="wp-block-heading has-text-align-center">Responsive</h6>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"aligncenter"} -->
<p class="aligncenter has-text-align-center aligncenter">Change the layout, size and spacing of sections depending on the users device width and screen size</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"className":"is-style-surface"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":6} -->
<h6 class="wp-block-heading has-text-align-center">SVG Icons</h6>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"aligncenter"} -->
<p class="aligncenter has-text-align-center aligncenter">Choose from multiple icon collections and easily customize the appearance of SVG images</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- wp:columns {"align":"wide","style":{"spacing":{"padding":{"top":"0","bottom":"var:preset|spacing|md"},"blockGap":{"top":"var:preset|spacing|md","left":"var:preset|spacing|md"},"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-columns alignwide" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:var(--wp--preset--spacing--md)"><!-- wp:column {"className":"is-style-surface"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":6} -->
<h6 class="wp-block-heading has-text-align-center">Extendable</h6>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"aligncenter"} -->
<p class="aligncenter has-text-align-center aligncenter">Easy to extend and make your own with a wide range of design related customization settings</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"className":"is-style-surface"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":6} -->
<h6 class="wp-block-heading has-text-align-center">Typography</h6>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"aligncenter"} -->
<p class="aligncenter has-text-align-center aligncenter">Easily change the font settings and try different font combinations with your design </p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"className":"is-style-surface"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":6} -->
<h6 class="wp-block-heading has-text-align-center">Positioning</h6>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"aligncenter"} -->
<p class="aligncenter has-text-align-center aligncenter">Create almost any kind of layout with the easy to use positioning and layout block settings</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
