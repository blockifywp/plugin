...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xxl);padding-bottom:var(--wp--preset--spacing--xxl)"><!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|md"}}},"className":"is-style-sub-heading"} -->
<p class="aligncenter has-text-align-center is-style-sub-heading aligncenter" style="margin-top:var(--wp--preset--spacing--md)">About</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|lg"}}}} -->
<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--lg)">Meet the team</h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:image {"style":{"aspectRatio":{"all":"16/9"}}} -->
<figure class="wp-block-image"><img alt=""/></figure>
<!-- /wp:image -->
<!-- wp:paragraph {"className":"is-style-heading"} -->
<p class="is-style-heading">Jess Brown</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>Co-founder &amp; CEO</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|xxs"}}},"fontSize":"14"} -->
<p class="has-14-font-size" style="margin-bottom:var(--wp--preset--spacing--xxs)">Integer ipsum odio platea orci quis tempus sociosqu. Fusce egestas ligula urna consectetur sem at.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:paragraph {"className":"is-style-heading"} -->
<p class="is-style-heading">Steve Jobs</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>Developer</p>
<!-- /wp:paragraph -->
