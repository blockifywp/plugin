...
<p class="aligncenter has-text-align-center is-style-sub-heading aligncenter" style="margin-top:var(--wp--preset--spacing--xs)">{archive_title}</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-query alignwide" style="padding-top:var(--wp--preset--spacing--sm);padding-bottom:0"><!-- wp:post-template {"layout":{"type":"grid","columnCount":3}} -->
...
<div class="wp-block-group"><!-- wp:query-pagination {"paginationArrow":"arrow","align":"full","style":{"typography":{"textDecoration":"none"},"spacing":{"padding":{"top":"var:preset|spacing|lg"}}},"className":"is-style-default","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
