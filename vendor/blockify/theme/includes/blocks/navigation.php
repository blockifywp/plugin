 ...
 * @return string
 */
function add_submenu_border_css( string $css, string $content, bool $is_editor ): string {

	if ( $is_editor || str_contains( $content, 'wp-block-navigation__submenu-container' ) ) {
